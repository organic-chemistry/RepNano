...
python src/repnano/data/preprocess.py  --hdf5 $root/BTF_BY_ONT_1_FAK41381_A.NB11_0.fast5 --fastq $root/BTF_BY_ONT_1_FAK41381_A.NB11.fastq --ref ${ref}  --output_name ${output_dir}/output.fast5 --njobs 2 --maxlen 40
